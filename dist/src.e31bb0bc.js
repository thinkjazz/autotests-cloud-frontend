...
function addSocketEvent(message) {
  ...
  switch (message.contentType) {
    ...
    case "generated":
      ...
      pre.setAttribute("data-prefix", ">");
      pre.innerHTML = "<code>".concat(message.content, " <br/><a class=\"questions\" href=\"").concat(message.url, "\">").concat(message.url, "</a></code>");
      break;
...
function displayNotification(url) {
  iframeBlock.innerHTML = "<iframe id=\"telegram-post-autotests_cloud-17\" class=\"telegram-iframe w-full h-full h-80\"\n          src=\"https://t.me/autotests_cloud/465?dark=1&comment=701&embed=1\"></iframe>"; // src="https://t.me/autotests_cloud/${resp}?embed=1&dark=1" frameborder="0" scrolling="yes"></iframe>`;
}
